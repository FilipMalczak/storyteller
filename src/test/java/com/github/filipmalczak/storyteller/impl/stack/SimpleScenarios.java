...
import com.github.filipmalczak.storyteller.impl.ExecutionTracker;
...
class SimpleScenarios {
    ...
    /*
     * Missing cases:
     * s(n(l1, l2)) -> s(nNew(l1, l2))
     * s(n(l1, l2)) -> s(nNew(l3, l4))
     * s(n(l1, l2)) -> s(n(lNew, l1, l2))
     * s(n1(l1, l2), n2(l3, l4)) -> s(n1(lNew, l1, l2), n2(l3, l4))
     * s(n1(l1, l2), n2(l3, l4)) -> s(n1(l1, l2, lNew), n2(l3, l4))
     * s(n1(l1, l2), n2(l3, l4)) -> s(n1(l1, l2), n2(lNew, l3, l4))
     * s(n1(l1, l2), n2(l3, l4)) -> s(nNew(l1, l2), n2(l3, l4))
     * s(n1(l1, l2), n2(l3, l4)) -> s(n1(l1, l2), nNew(l3, l4))
     */
}