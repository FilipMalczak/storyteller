...
public interface TaskTree<Id extends Comparable<Id>, Definition, Type extends Enum<Type> & TaskType, NoSql> {
    ...
    Task<Id, Definition, Type> executeOrdered(Definition definition, Type type, NodeBody<Id, Definition, Type, NoSql> body);

    Task<Id, Definition, Type> executeOrdered(Definition definition, Type type, LeafBody<Id, Definition, Type, NoSql> body);
