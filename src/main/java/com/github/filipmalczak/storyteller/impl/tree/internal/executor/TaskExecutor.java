...
public interface TaskExecutor<Id extends Comparable<Id>, Definition, Type extends Enum<Type> & TaskType, NoSql> {
    ...
    Task<Id, Definition, Type> executeSequentialNode(TaskSpec<Definition, Type> taskSpec, NodeBody<Id, Definition, Type, NoSql> body, Callback<Id, Definition, Type> callback);

    Task<Id, Definition, Type> executeParallelNode(TaskSpec<Definition, Type> taskSpec, NodeBody<Id, Definition, Type, NoSql> body, TaskTree.IncorporationFilter<Id, Definition, Type, NoSql> filter, Callback<Id, Definition, Type> callback);

    Task<Id, Definition, Type> executeLeaf(TaskSpec<Definition, Type> taskSpec, LeafBody<Id, Definition, Type, NoSql> body, Callback<Id, Definition, Type> callback);
